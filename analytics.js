/* Kirton Learning — page measurement.
   ...
   /upload carries a one-time token in its query string and /admin is the
   back office. Neither ever loads a beacon, so neither the path nor the
   token can reach a third party even by accident. The guard lives here, in
...
(function () {
  ...
  var NEVER = ['/upload', '/upload.html', '/admin', '/admin.html'];
